...
;// CONCATENATED MODULE: ./src/geoms/shape.ts
class Shape {
    constructor(ctx) {
        this.ctx = ctx;
    }
...
;// CONCATENATED MODULE: ./src/geoms/arc.ts
...
;// CONCATENATED MODULE: ./src/geoms/circle.ts
...
;// CONCATENATED MODULE: ./src/geoms/line.ts
...
class CanvasLayer {
    ...
    createCircles(context, data, min, range, dataBounds, pixelBounds) {
    ...
    createLines(context, data, dataBounds, pixelBounds) {
        const points = [];
        for (const item of data) {
            const point = remapPoint(dataBounds, pixelBounds, {
                x: item.x,
        ...
        const shapeProps = this.datasetProps;
